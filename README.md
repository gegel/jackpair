...
TRNG is charged with LSB of the white noise on power voltage resistive divide. Accumulated entropy is estimated by 4-bits block frequency test, gathering is performed  to a sufficient statistic.
